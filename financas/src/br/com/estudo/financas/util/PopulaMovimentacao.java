...
public class PopulaMovimentacao {
	...
	public static void main(String[] args) {
		...
		movimentacao5.setTipo(TipoMovimentacaoEnum.SAIDA);
		...
		movimentacao6.setTipo(TipoMovimentacaoEnum.ENTRADA);
		...
		movimentacao7.setTipo(TipoMovimentacaoEnum.SAIDA);
		...
		movimentacao8.setTipo(TipoMovimentacaoEnum.SAIDA);
		...
		movimentacao9.setTipo(TipoMovimentacaoEnum.ENTRADA);
		...
		movimentacao10.setTipo(TipoMovimentacaoEnum.SAIDA);
		...
		movimentacao11.setTipo(TipoMovimentacaoEnum.ENTRADA);
		...
		movimentacao12.setTipo(TipoMovimentacaoEnum.ENTRADA);
